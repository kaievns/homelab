...
if sudo firewall-cmd  --info-service=k0s ; then
    ...
    sudo firewall-cmd --permanent --service=k0s --add-port=7946/tcp # metallb
    sudo firewall-cmd --permanent --service=k0s --add-port=7946/udp # metallb
    sudo firewall-cmd --permanent --service=k0s --add-port=9443/tcp # controller <-> controller
    sudo firewall-cmd --permanent --service=k0s --add-port=10250/tcp # kubelet
